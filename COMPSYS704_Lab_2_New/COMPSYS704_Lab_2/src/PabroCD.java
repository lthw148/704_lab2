...
public class PabroCD extends ClockDomain{
        ...
        switch(S26){
          case 0 : 
            if(R.getprestatus()){//sysj/Exercise6.sysj line: 10, column: 10
              ...
              int biggest1499 = 0;
              if(ends[3]>=biggest1499){
                biggest1499=ends[3];
              }
              if(ends[4]>=biggest1499){
                biggest1499=ends[4];
              }
              if(biggest1499 == 1){
                active[2]=1;
              ...
              switch(S8){
                case 0 : 
                  ...
                  int biggest1502 = 0;
                  if(ends[3]>=biggest1502){
                    biggest1502=ends[3];
                  }
                  if(ends[4]>=biggest1502){
                    biggest1502=ends[4];
                  }
                  if(biggest1502 == 1){
                    active[2]=1;
  ...
  public void thread1490(int [] tdone, int [] ends){
    ...
    int biggest1493 = 0;
    if(ends[3]>=biggest1493){
      biggest1493=ends[3];
    }
    if(ends[4]>=biggest1493){
      biggest1493=ends[4];
    }
    if(biggest1493 == 1){
      active[2]=1;
    ...
    RUN: while(true){
      switch(S439){
        ...
        case 2 : 
          ...
          int biggest1504 = 0;
          if(ends[2]>=biggest1504){
            biggest1504=ends[2];
          }
          if(ends[5]>=biggest1504){
            biggest1504=ends[5];
          }
          if(biggest1504 == 1){
            active[1]=1;
